...
```json
{
  ...
  "team_progress": {
    "T1-backend": { "status": "in-progress", "items_completed": 1, "items_remaining": 2 },
    "T2-frontend": { "status": "pending", "items_completed": 0, "items_remaining": 0 },
    "T3-data": { "status": "complete", "items_completed": 1, "items_remaining": 0 },
    "T4-infra": { "status": "not-assigned", "items_completed": 0, "items_remaining": 0 },
    "T5-devops": { "status": "not-assigned", "items_completed": 0, "items_remaining": 0 },
    "T6-testing": { "status": "pending", "items_completed": 0, "items_remaining": 3 },
    "T7-security": { "status": "not-assigned", "items_completed": 0, "items_remaining": 0 },
    "T8-docs": { "status": "not-assigned", "items_completed": 0, "items_remaining": 0 },
    "T9-product": { "status": "not-assigned", "items_completed": 0, "items_remaining": 0 },
    "T10-quality": { "status": "not-assigned", "items_completed": 0, "items_remaining": 0 }
  },
  "todo_items": [
...
{"timestamp":"2026-02-23T10:02:00.000Z","action":"phase_start","phase":2,"phase_name":"Planning"}
{"timestamp":"2026-02-23T10:03:30.000Z","action":"plan_created","task":"Add rate limiting","steps":4,"files_to_touch":5}
{"timestamp":"2026-02-23T10:03:31.000Z","action":"phase_start","phase":3,"phase_name":"Implementation"}
...
{"timestamp":"2026-02-23T10:12:01.000Z","action":"phase_start","phase":4,"phase_name":"Validation"}
{"timestamp":"2026-02-23T10:13:15.000Z","action":"quality_gate","result":"pass","format":"pass","lint":"pass","typecheck":"pass","tests":"pass","build":"pass"}
{"timestamp":"2026-02-23T10:13:16.000Z","action":"phase_start","phase":5,"phase_name":"Ship"}
{"timestamp":"2026-02-23T10:14:00.000Z","action":"handoff_saved","path":"docs/ai_handoffs/2026-02-23-rate-limiting.md"}
...
|--------|-------|-------------|
| `phase_start` | Any | Orchestrator transitions to a new phase |
...
| `quality_gate` | 4 | Full quality check results |
| `review_complete` | 4 | Code review verdict |
| `handoff_saved` | 5 | Handoff document written to disk |
| `session_complete` | 5 | Orchestration run finished |
| `lock_acquired` | Any | Session lock taken |
| `lock_released` | Any | Session lock released |
