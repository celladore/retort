...
describe('syncCopilotInstructions — testing & QA templates (via runSync --only copilot)', () => {
  ...
  it('generates .github/instructions/kluster-code-verify.md', { timeout: 15000 }, () => {
    expect(
  ...
  it('kluster-code-verify.md contains Verification Scope section', () => {
    const content = readFileSync(
      resolve(projectRoot, '.github', 'instructions', 'kluster-code-verify.md'),
      'utf-8'
    );
    expect(content).toContain('Verification Scope');
  });

  it('kluster-code-verify.md contains Sign-Off Criteria', () => {
    const content = readFileSync(
      resolve(projectRoot, '.github', 'instructions', 'kluster-code-verify.md'),
      'utf-8'
    );
  ...
  it('instructions README.md lists testing.md, quality.md, and kluster-code-verify.md', () => {
    const content = readFileSync(
    ...
    expect(content).toContain('kluster-code-verify.md');
  });
});
