...
describe('getGeneratedHeader', () => {
  it('generates a markdown header', () => {
    ...
    // The version is deliberately absent from per-file headers — it lives in
    // .agentkit/GENERATED.json so a release does not rewrite every file.
    expect(header).toContain('GENERATED by Retort — DO NOT EDIT');
    expect(header).not.toContain('v0.1.0');
