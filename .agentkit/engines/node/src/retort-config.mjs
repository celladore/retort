/**
 * Retort — .retortconfig Loader, Validator, and Write Utilities
 *
 ...
 *
 * Also provides helpers for creating/updating `.retortconfig` (used by the
 * `retort init` wizard).
 *
 * Schema (YAML):
...
// ---------------------------------------------------------------------------
// Write utilities (used by `retort init` wizard)
// ---------------------------------------------------------------------------
 ...
 * Does NOT validate — use `loadRetortConfig` when strict validation is needed.
 *
...
// ---------------------------------------------------------------------------
// Load + validate (used by sync engine)
// ---------------------------------------------------------------------------
