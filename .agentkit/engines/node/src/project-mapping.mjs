export const PROJECT_MAPPING = [
  ...
  { src: 'branchProtection.requireCodeOwnerReviews', dest: 'bpRequireCodeOwnerReviews', type: 'boolean' },
  { src: 'branchProtection.requireLastPushApproval', dest: 'bpRequireLastPushApproval', type: 'boolean' },
  ...
  { src: 'branchProtection.requiredLinearHistory', dest: 'bpRequiredLinearHistory', type: 'boolean' },
  ...
  { src: 'branchProtection.copilotReview.enabled', dest: 'bpCopilotReviewEnabled', type: 'boolean' },
  { src: 'branchProtection.copilotReview.reviewNewPushes', dest: 'bpCopilotReviewNewPushes', type: 'boolean' },
  { src: 'branchProtection.copilotReview.reviewDraftPRs', dest: 'bpCopilotReviewDraftPRs', type: 'boolean' },
  { src: 'branchProtection.mergeStrategies.allowMergeCommits', dest: 'bpAllowMergeCommits', type: 'boolean' },
  { src: 'branchProtection.mergeStrategies.allowSquashMerge', dest: 'bpAllowSquashMerge', type: 'boolean' },
  { src: 'branchProtection.mergeStrategies.allowRebaseMerge', dest: 'bpAllowRebaseMerge', type: 'boolean' },
