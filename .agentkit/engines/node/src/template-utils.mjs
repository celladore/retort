...
export function getGeneratedHeader(version, repoName, ext, vars = {}) {
  ...
  return [
    // The framework version is deliberately absent: embedding it here made every
    // release rewrite ~660 files with no semantic change, which also defeats the
    // write-if-changed guard. Version and spec provenance live in a single
    // tracked manifest, .agentkit/GENERATED.json. See ADR-11 decision 2.
    `${comment.start} GENERATED by Retort — DO NOT EDIT${suffix}`,
