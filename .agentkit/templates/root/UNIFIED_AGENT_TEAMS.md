...
- **Activities**:
  ...
  - Run `pnpm -C .agentkit retort:sync` if any spec files changed, and commit regenerated outputs
...
_This specification is maintained by Retort. Do not edit directly._
_Run `pnpm -C .agentkit retort:sync` to regenerate from the canonical spec._
