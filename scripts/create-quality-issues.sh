...
echo "  Created: shell domain in rules.yaml"
...
echo "  Created: ShellCheck CI step"
...
echo "  Created: PowerShell domain in rules.yaml"
...
echo "  Created: check.mjs allowlists and resolvers"
...
echo "  Created: TypeScript-specific rules enhancement"
...
echo "  Created: Section 7 documentation"
...
echo "  Created: Shell language instruction template"
...
echo "  Created: PowerShell language instruction template"
...
echo "  Created: Update format and check templates"
...
echo "  Created: CSS domain in rules.yaml"
...
echo "  Created: JSX accessibility linting"
...
echo "  Created: discover.mjs enhancements"
...
echo "  Created: CONTRIBUTING.md update"
...
echo "  Created: Model guide updates"
...
echo "  Created: ADR-06 weighted decision matrix"
...
echo "  Created: PSScriptAnalyzer in Windows CI"
...
echo "  Created: SonarCloud evaluation"
...
echo "  Created: Epic tracking issue"
