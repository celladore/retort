...
- Fallback policy (approved by platform leads on 2026-02-26; see [AKF-INFRA-001](../../architecture/decisions/02-fallback-policy-tokens-problem.md)): if `tokens/problem` is missing, keep current Cost scores unchanged and mark cost evidence as `Not evaluated`.
