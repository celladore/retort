...
> These files are planned but not yet authored. They are defined in
> [`.agentkit/spec/docs.yaml`](../../.agentkit/spec/docs.yaml) and will be
> created when content is ready.
