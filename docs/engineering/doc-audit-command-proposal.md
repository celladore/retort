...
> **Status**: Proposed
> **Date**: 2026-03-04
> **Purpose**: Add a repeatable documentation audit command to retort
...
3. **Respect generated files.** Files marked `GENERATED by Retort — DO NOT EDIT` should only be flagged if they are out of sync with their spec — never edit them directly.
