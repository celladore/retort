...
Retort governs agent behaviour through **three enforcement layers**:
...
| Source                             | Says                                                                                   |
| ---------------------------------- | -------------------------------------------------------------------------------------- |
| **CLAUDE.md** safety rule #5       | "Never directly edit files marked `GENERATED by Retort`"                               |
...
| **copilot-instructions.md** header | `<!-- GENERATED by Retort v0.2.1 — DO NOT EDIT -->`                              |
...
| Source                             | Version         |
| ---------------------------------- | --------------- |
| **AGENTS.md** header               | `Retort v3.1.0` |
| **copilot-instructions.md** header | `Retort v0.2.1` |
| **COMMAND_GUIDE.md** header        | `Retort v3.1.0` |
