...
## Project Review Findings (2026-03-10)

Findings from `/project-review` on `chore/project-review` branch. Wave 1–3 implementation.

| ID     | Title                                                  | Priority | Status      | Plan File | Blockers | GH Issue |
| ------ | ------------------------------------------------------ | -------- | ----------- | --------- | -------- | -------- |
| PR-001 | Flaky discover test (temp fixture)                     | P0       | completed   | —         | None     | —        |
| PR-002 | Prettier formatting drift                              | P1       | completed   | —         | None     | —        |
| PR-003 | Issue label validation (form-template skip)            | P1       | completed   | —         | None     | —        |
| PR-004 | Stale orchestrator state                               | P1       | completed   | —         | None     | —        |
| PR-005 | claude.yml uses ubuntu-latest                          | P1       | completed   | —         | None     | —        |
| PR-006 | Stale branch protection context names                  | P1       | completed   | —         | None     | —        |
| PR-007 | Command injection in resolve-merge.sh                  | P0       | completed   | —         | None     | —        |
| PR-008 | Create area/priority labels, remove invalid-fields     | P1       | completed   | —         | None     | —        |
| PR-009 | Delete orphaned files, remove duplicate test           | P2       | completed   | —         | None     | —        |
| PR-010 | CHANGELOG.md entries for recent work                   | P2       | completed   | —         | None     | —        |
| PR-011 | Add --generate-plans flag to project-review            | P2       | not-started | —         | None     | —        |
| PR-012 | Generalized label management via spec (labels section) | P3       | not-started | —         | None     | —        |
| PR-013 | Auto-changelog from conventional commits (git-cliff)   | P3       | not-started | —         | None     | —        |
| PR-014 | Backlog freshness CI gate + session-start hook         | P3       | not-started | —         | None     | —        |
