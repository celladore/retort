...
```text
docs/**, docs/03_architecture/02_decisions/**, .github/**, README.md, CHANGELOG.md, CONTRIBUTING.md
```
...
1. **Stay in scope.** Work on files matching `docs/**, docs/03_architecture/02_decisions/**, .github/**, README.md, CHANGELOG.md, CONTRIBUTING.md`. Log out-of-scope findings for other teams.
