...
description: 'Use for plan, review, document work in docs/architecture/**, docs/planning/**. Defines and enforces framework governance policies — versioning strategy, breaking change protocols, deprecation timelines, and cross-repo consistency standards.'
model: inherit
color: red
---
