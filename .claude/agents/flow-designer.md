---
name: flow-designer
description: 'Use for plan, implement work in .agentkit/spec/commands.yaml, .agentkit/spec/teams.yaml. Designs the team command, flags, and integration points with other teams.'
model: inherit
isolation: worktree
color: purple
---
