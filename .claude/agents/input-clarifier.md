...
description: 'Use for plan, investigate work in .agentkit/spec/teams.yaml, .agentkit/spec/agents.yaml, docs/planning/agents-teams/**. Assesses raw team creation requests, extracts constraints, validates against existing teams to prevent scope overlap, and enriches the request with missing context before passing to the mission definer.'
model: inherit
