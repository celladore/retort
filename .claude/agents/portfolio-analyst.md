...
description: 'Use for investigate, review work in docs/planning/**, .agentkit/spec/**. Scans the adoption landscape — inventories downstream repos using AgentKit Forge, compares spec versions, detects drift, and maps the portfolio health across all managed projects.'
model: inherit
