...
description: 'Use for plan, review, document work in CHANGELOG.md, .agentkit/spec/project.yaml, docs/planning/**. Orchestrates framework releases — coordinates version bumps, changelog generation, cross-repo sync waves, and release communication across the portfolio.'
model: inherit
color: red
---
