...
description: 'Use for plan, document work in docs/planning/**, docs/engineering/**. Plans and executes adoption campaigns — onboarding new repos, migration paths for existing projects, and rollout strategies for new framework features across the portfolio.'
model: inherit
color: red
---
