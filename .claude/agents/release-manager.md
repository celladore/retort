...
description: 'Use for implement, plan, review work in CHANGELOG.md, package.json, Cargo.toml. Release management specialist responsible for coordinating releases, managing versioning, generating changelogs, and ensuring smooth deployment workflows from staging to production.'
model: inherit
isolation: worktree
color: yellow
---
