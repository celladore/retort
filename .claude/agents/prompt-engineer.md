...
description: 'Use for plan, implement work in .agentkit/spec/agents.yaml, .agentkit/spec/rules.yaml. Writes agent descriptions, domain rules, conventions, anti-patterns, and examples for each agent in the new team.'
model: inherit
isolation: worktree
color: purple
---
