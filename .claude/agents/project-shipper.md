...
description: 'Use for plan, review work in .github/ISSUE_TEMPLATE/**, .github/PULL_REQUEST_TEMPLATE/**, docs/handoffs/**. Delivery-focused project management specialist responsible for moving work through the pipeline from planning to production.'
model: inherit
