...
Define the exception process for emergency changes that would otherwise be blocked by Retort branch-governance guardrails.
...
1. Open or reference a tracking issue in `phoenixvc/retort`.
