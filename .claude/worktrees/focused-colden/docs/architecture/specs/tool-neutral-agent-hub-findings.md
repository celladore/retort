...
| Concern | Retort | Mystira | Winner | Notes |
|---|---|---|---|---|
...
The `.agents/` pattern is simple enough to become a cross-project convention. If formalised with a JSON Schema for guards and a directory layout spec, it could be adopted by any AI agent system — not just Retort consumers.
