...
description: 'Scans the adoption landscape — inventories downstream repos using Retort, compares spec versions, detects drift, and maps the portfolio health across all managed projects.'
generated_by: 'retort'
...
Scans the adoption landscape — inventories downstream repos using Retort, compares spec versions, detects drift, and maps the portfolio health across all managed projects.
...
- Inventory all repos using Retort (via overlay registry or manifest)
