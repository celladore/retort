...
**Role:** Scans the adoption landscape — inventories downstream repos using Retort, compares spec versions, detects drift, and maps the portfolio health across all managed projects.
