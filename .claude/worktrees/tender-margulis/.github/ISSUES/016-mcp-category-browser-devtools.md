# feat(mcp): Evaluate browser and devtools MCP category support

**Priority:** P2 — Medium
**Labels:** `enhancement`, `mcp`, `browser`, `devtools`
**Blocked by:** #014
...
Evaluate support patterns for browser/devtools MCP servers, including:

- Puppeteer
- Chrome DevTools MCP
- Related browser automation / inspection tools
