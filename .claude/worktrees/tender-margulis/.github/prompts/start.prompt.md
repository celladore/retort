...
- **Orchestrator has prior state?** — `.github/state/orchestrator.json` exists
- **Backlog has items?** — `AGENT_BACKLOG.md` exists with content beyond header
- **Active tasks?** — `.github/state/tasks/` contains JSON files
- **Current git branch** — `git branch --show-current`
- **Uncommitted changes?** — `git status --porcelain`
- **Orchestrator phase** — read `phase` from `.github/state/orchestrator.json`
- **Lock held?** — `.github/state/orchestrator.lock` exists
