...
#
# Usage:
#   .agentkit/bin/setup-branch-protection.ps1 [-Branch main] [-DryRun]
# ---------------------------------------------------------------------------
...
Write-Host ""
Write-Host "Branch protection applied successfully to $Repo/$Branch"
Write-Host ""
...
Write-Host ""
Write-Host "Done. Branch protection and labels are configured."
Write-Host ""
Write-Host "To verify: gh api /repos/$Repo/branches/$Branch/protection"
