...
- Files with the header `GENERATED by Retort — DO NOT EDIT` are sync outputs
- **Never edit generated files directly** — modify `.agentkit/spec/*.yaml` then run `pnpm --dir .agentkit retort:sync`
