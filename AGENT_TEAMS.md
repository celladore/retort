...
| MARKETING     | marketing     | Content strategy, growth, positioning, lifecycle                           | `content/**`, `blog/**`, `docs/marketing/**`, `analytics/**`, `docs/metrics/**`                                                 | implement, review, investigate                 | docs → product                  | Active | —          |
